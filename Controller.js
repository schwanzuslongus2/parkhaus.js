    ...
    var component  = {
        ...
        config: {
            ...
            messages: {
                ...
                invalid_slot: { tag: 'li', inner: '%id% ungÃ¼ltig.' },
            },
        ...
        Instance: function () {
            ...
            this.start = async () => {
                ...
                class Car {
                    ...
                    toArray(){
                        const list = [ this.nr, this.timer, this._duration, this.price(), this.hash(), this.color(), this.space, this.client_category, this.vehicle_type, this.license ];
